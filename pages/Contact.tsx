                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <a href={`tel:+201096677671`} className="flex items-center gap-4 group">
                                        ...
                                        <div>
                                            <span className="block text-xs font-bold text-gray-400 mb-1 uppercase tracking-widest">الهاتف</span>
                                            <span className="text-lg md:text-xl font-bold">{lang === 'ar' ? '201096677671+' : '+201096677671'}</span>
                                        </div>
                                    </a>
                                    ...
                                    <a href={`https://wa.me/201067096677`} target="_blank" rel="noreferrer" className="flex items-center gap-4 group">
                                        ...
                                        <div>
                                            <span className="block text-xs font-bold text-gray-400 mb-1 uppercase tracking-widest">واتساب</span>
                                            <span className="text-lg md:text-xl font-bold">{lang === 'ar' ? '201067096677+' : '+201067096677'}</span>
                                        </div>
                                    </a>
